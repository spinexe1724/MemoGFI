...
<div class="max-w-8xl mx-auto">
    <div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100">
        ...
        {{-- PERUBAHAN: Menambahkan enctype agar bisa upload file --}}
        <form action="{{ route('memos.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {{-- PERUBAHAN: Menambahkan Kolom Lampiran Dokumen --}}
                <div class="md:col-span-3">
                    <div class="bg-blue-50/50 border border-blue-100 rounded-2xl p-6">
                        ...
                        <p class="text-[10px] text-gray-400 mt-2 italic">* Anda dapat memilih lebih dari satu file (Multiple Upload). Maksimal 10MB per file.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-100">
                ...
                <button type="submit" name="action" value="draft" class="bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold py-3 px-8 rounded-xl border border-gray-200 transition-all">Simpan Draf</button>
...
<style>
    ...
    .ck-image-resizer__handle:hover { background: #005a87; }
</style>
